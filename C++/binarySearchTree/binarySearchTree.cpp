...
BinarySearchTreeNode *insertTree(ElementType value, BinarySearchTreeNode *tree)
{
	if (nullptr == tree)
	{
		tree = new BinarySearchTreeNode();
		// cout << "sizeof BinarySearchTreeNode left is : " << sizeof(tree->left) << endl;
		if (nullptr == tree)
		{
...
BinarySearchTreeNode *deleteTree(ElementType value, BinarySearchTreeNode *tree)
{
	if (nullptr == tree)
	{
...
int main()
{
	...
	// cout << "sizeof BinarySearchTreeNode is : " << sizeof(BinarySearchTreeNode) << endl;
	...
	if (find_ret != nullptr)
	{
		cout << "i foud the value use findTree and the value is : " << find_ret->value << endl;
	}
	else
	{
