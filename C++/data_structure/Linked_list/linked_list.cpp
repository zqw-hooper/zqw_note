...
Linked_List_Node *insert_list(Linked_List_Node *insert_list, int value,
                              Linked_List_Node *before,
                              Linked_List_Node *after) {
...
Linked_List_Node *delete_list(int value, Linked_List_Node *ptemp) {
  ...
  while (current != NULL) {
    if (current->value == value) {
      ...
      // {
      // 	current->next = NULL;
      // 	cout << RED << "what you want to delete is the head Linked List
      // !" << WHITE << endl;
      // }
      // else
      // {
  ...
  if (flag == true) {
    ...
    cout << RED << "not find what you want to delete Linked List !" << WHITE
         << endl;
  }
}
...
// 			// {
// 			// 	odd = ptemp;
// 			// 	cout << "1list odd value is : " << ptemp->value
// <<
// endl;
// 			// }
// 			// else
// 			// {
// 			// 	cout << "2list odd value is : " << ptemp->value
// <<
// endl;
// 			// 	odd->next = ptemp;
// 			// 	cout << "3list odd value is : " << odd->value <<
// endl;
// 			// }
// 		}
// 		else
